"""
Django settings for Shree_Rastriya_Secondary_School project.
...
SECRET_KEY = " _j=t)yec7-gmuah@53_ml&+5-5g$lxr*(4u%lcm+tu#*phxvmu "
...
WSGI_APPLICATION = 'Shree_Rastriya_Secondary_School.wsgi.application'
