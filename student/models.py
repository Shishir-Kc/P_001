...
from data_class.models import Class,Attendance
...
class Student_info(models.Model):
    ...
    student_class = models.ForeignKey('data_class.Class',on_delete=models.CASCADE,verbose_name="student_class",null=True,blank=True)
